...
#import <Stacker/StackerDefaultTransition.h>
...
- (void)setViewControllers:(NSArray<__kindof UIViewController *> *)viewControllers duration:(CFTimeInterval)duration completion:(void(^_Nullable)(BOOL finished))completion NS_SWIFT_NAME(setViewControllers(_:duration:completion:));
...
- (void)pushViewController:(__kindof UIViewController *)viewController duration:(CFTimeInterval)duration completion:(void(^_Nullable)(BOOL finished))completion NS_SWIFT_NAME(pushViewController(_:duration:completion:));
...
- (void)pushViewControllers:(NSArray<__kindof UIViewController *> *)viewControllers duration:(CFTimeInterval)duration completion:(void(^_Nullable)(BOOL finished))completion NS_SWIFT_NAME(pushViewControllers(_:duration:completion:));
...
- (nullable __kindof UIViewController *)popViewControllerWithDuration:(CFTimeInterval)duration completion:(void(^_Nullable)(BOOL finished))completion NS_SWIFT_NAME(popViewController(duration:completion:));
...
- (nullable NSArray<__kindof UIViewController *> *)popToRootViewControllerWithDuration:(CFTimeInterval)duration completion:(void(^_Nullable)(BOOL finished))completion NS_SWIFT_NAME(popToRootViewController(duration:completion:));
...
- (nullable NSArray<__kindof UIViewController *> *)popToViewController:(UIViewController *)viewController duration:(CFTimeInterval)duration completion:(void(^_Nullable)(BOOL finished))completion NS_SWIFT_NAME(popToViewController(_:duration:completion:));
